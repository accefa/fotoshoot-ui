...
public class Program extends Application {
    ...
    private static final String DRIVES_LAYOUT = "/fxml/Drives.fxml";
    private static final String DRIVES_TITLE = "Motoren";
    private static final String ACTION_LOG_LAYOUT = "/fxml/ActionOverview.fxml";
    private static final String ACTION_LOG_TITLE = "Log";
    private static final String IMAGE_CONFIG_LAYOUT = "/fxml/ImageConfig.fxml";
    private static final String IMAGE_CONFIG_TITLE = "Bild-Erkennung";
    private static final String PI_LAYOUT = "/fxml/Pi.fxml";
    private static final String PI_TITLE = "Ballwurf";
    private static final String ROOT_LAYOUT = "/fxml/RootLayout.fxml";
    ...
    public void start(final Stage primaryStage) {
        ...
        primaryStage.getIcons().add(
                new Image(this.getClass().getClassLoader().getResourceAsStream("Tennisball.png")));
    ...
    private BorderPane createRootlayout() {
        return (BorderPane) new ApplicationFxmlLoader().createLoader(injector,
                RootLayoutController.class, ROOT_LAYOUT);
    }
    ...
    private Parent createNodeImageConfig() {
        return new ApplicationFxmlLoader().createLoader(injector, ImageConfigController.class,
                IMAGE_CONFIG_LAYOUT);
    }
    ...
    private Parent createNodeActionLog() {
        return new ApplicationFxmlLoader().createLoader(injector, ActionOverviewController.class,
                ACTION_LOG_LAYOUT);
    }

    private Parent createNodeDrives() {
        return new ApplicationFxmlLoader().createLoader(injector, DriveController.class,
                DRIVES_LAYOUT);
    }
